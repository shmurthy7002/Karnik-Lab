...
Molecule_Generation houses an implementation of Microsfot MoLeR that I fine-tuned to generate reasonable ligands for the AT1R receptor, trained with ARBs that are currently in circulation (clinically tested, I think I used 8). There isn't much special sauce, I just followed their instructions for fine-tuning.
